...
describe EasyWebService::Client do
  before :each do
  ...
  subject{ EasyWebService::Client.new(options) }
  ...
  describe "#register_strategy" do
    it "should return self" do
      subject.register_strategy("http").should be_a EasyWebService::Client
    end

    it "should set request strategies" do
      subject.register_strategy("http")
      subject.instance_variable_get("@request_strategy_registrar").get("http").should be_a EasyWebService::RequestHandler::Http
    end
  end
  ...
  describe "#register_authentication_scheme" do
    ...
    it "should register the authentication scheme for the specific request strategy" do
      ...
      subject.instance_variable_get('@authentication_scheme_registrar').get('api_key', 'http').should be_a EasyWebService::RequestHandler::Http::Authentication::ApiKey
    end
