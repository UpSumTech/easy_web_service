...
describe EasyWebService::RequestHandler::Http::WrappedResponse do
  before :each do
    @code = 200
  end

  subject do
    EasyWebService::RequestHandler::Http::WrappedResponse.new(OpenStruct.new(:code => @code, :headers => ["Foo", "Bar"], :body => "{\"test_key\":\"test val\"}"))
  end
